...
public class Collectable : MonoBehaviour
{
    ...
    [SerializeField] Player AstroTot;
    ...
    {
        if (col.gameObject == AstroTot.gameObject)
        {
            Collect();
        }
    ...
    public void Collect()
    {
        ...
        {
            if (AstroTot.currentHealth < AstroTot.maxHealth)
            {
                AstroTot.currentHealth += itemAmount;
                AstroTot.healthBar.SetHealth(AstroTot.currentHealth);
            }
        }
